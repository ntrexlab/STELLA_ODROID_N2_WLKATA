...
#define pulse_per_rev               142000        // 한바퀴 회전시 엔코더 펄스 카운트(이 값은 부착된 엔코더와 감속기를 고려해 정해진다.) [pulse / rev]
#define pulse_per_distance          251238.49964614    // 1m 이동시 엔코더 펄스 카운트 [pulse / m]
#define gear_ratio                  71           // 감속비
